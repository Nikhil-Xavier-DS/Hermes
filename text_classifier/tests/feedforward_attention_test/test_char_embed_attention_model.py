...
import os
#
# from Hermes.text_classifier.feedforward_attention_model.char_embed_attention_model import FeedForwardAttention
...
if __name__ == "__main__":
    ...
    model = FeedForwardAttention(len(char2idx), params['char_embed_size'], params['cnn_filters'],
