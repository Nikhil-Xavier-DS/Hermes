...
from Hermes.natural_language_classifier.feedforward_attention_model.char_embed_attention import FeedForwardAttentionTextClassifier
...
if __name__ == "__main__":
    ...
    model = FeedForwardAttentionTextClassifier(len(char2idx), params['char_embed_size'], params['cnn_filters'],
                                 params['cnn_kernel_size'], params['dropout_rate'], params['max_char_len, lr'])
