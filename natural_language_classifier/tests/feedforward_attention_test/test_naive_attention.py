...
from Hermes.natural_language_classifier.feedforward_attention_model.naive_attention import FeedForwardAttentionTextClassifier
...
if __name__ == "__main__":
    ...
    model = FeedForwardAttentionTextClassifier(params['lr'], params['dropout_rate'])
