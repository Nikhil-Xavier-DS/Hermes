...
from Hermes.natural_language_classifier.feedforward_attention_model.cnn_attention import FeedForwardAttentionTextClassifier
from Hermes.natural_language_classifier.dataset.loader import dataset
...
if __name__ == "__main__":
    ...
    model = FeedForwardAttentionTextClassifier(params['lr'], params['dropout_rate'], params['kernel_size'])
