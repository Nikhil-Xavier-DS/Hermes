...
from Hermes.natural_language_classifier.parallel_recurrent_model.sliced_lstm import ParallelLSTMTextClassifier
...
if __name__ == "__main__":
    ...
    model = tf.keras.models.load_model("sliced_lstm_model.h5")
