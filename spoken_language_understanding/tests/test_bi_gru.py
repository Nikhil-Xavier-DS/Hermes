...
"""Test case for Bidirectional GRU Model for Spoken Language Understanding"""

import tensorflow as tf
import os

from Hermes.spoken_language_understanding.bi_lstm_model.bi_lstm import BGRUModel
...
if __name__ == "__main__":
    ...
    model = BGRUModel(params['intent_size'], params['slot_size'], params['lr'], params['dropout_rate'], params['units'])
    ...
    model = tf.keras.models.load_model("bidirectional_gru_model.h5")
