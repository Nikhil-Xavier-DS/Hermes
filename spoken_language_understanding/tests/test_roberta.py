...
"""RoBERTa (Robustly Optimized BERT Pretraining Approach) Model for Spoken Language Understanding """

import tensorflow as tf
import os

from Hermes.spoken_language_understanding.bi_lstm_model.bert import RoBERTaModel
from Hermes.spoken_language_understanding.dataset.loader import roberta_dataset
...
if __name__ == "__main__":
    ...
    model = RoBERTaModel(params['intent_size'], params['slot_size'], params['lr'], params['dropout_rate'], params['units'])
