...
"""Test case for BERT (Bidirectional Encoder Representations from Transformers) Model for Spoken Language
Understanding """

import tensorflow as tf
import os

from Hermes.spoken_language_understanding.bi_lstm_model.bert import BERTModel
from Hermes.spoken_language_understanding.dataset.loader import bert_dataset
...
if __name__ == "__main__":
    ...
    model = BERTModel(params['intent_size'], params['slot_size'], params['lr'], params['dropout_rate'], params['units'])
