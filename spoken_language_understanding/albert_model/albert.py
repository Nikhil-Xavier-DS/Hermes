...
"""A ALBERT (A Lite Bidirectional Encoder Representations from Transformers) Model for Spoken Language Understanding"""
...
class ALBERTModel(Model):
    ...
    def call(self, albert_inps, training=False):
        albert_inps = [tf.cast(inp, tf.int32) for inp in albert_inps]
        x = self.albert(albert_inps, training=training)[0]
