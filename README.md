...
>* Feedforward Attention based Text Classification Model (Naive attention, CNN based attention, Char embed attention)
>* Parallel Recurrent based Text Classification Model (Sliced LSTM, Sliced LSTM with attention)
